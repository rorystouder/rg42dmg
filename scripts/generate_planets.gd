...
# Planet data based on your table
var planets = [
	{
		"name": "epsilon_station",
		"type": "Space Station",
		"features": "Trade hub, mission board",
		"terrain_size": Vector3(100, 0.1, 100),  # Thin for station
		"terrain_color": Color(0.8, 0.8, 0.8),   # Silver
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0, 1, 0),         # Green
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0, 0.5, 1),       # Metallic blue
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.5, 0.8, 0),     # Brown-green
	...
	},
	{
		...
		"terrain_color": Color(1, 0.2, 0.2),     # Reddish
		"building": {"type": "Rock", "size": Vector3(5, 5, 5), "pos": Vector3(10, 2.5, 10)},
		"npc": null  # No NPC due to hostility
	},
	{
		"name": "sirius_verge",
		"type": "Trade Hub",
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.7, 0.7, 0.7),   # Light gray
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.3, 0.3, 0.3),   # Dark gray
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.6, 0.4, 0.2),   # Brown
	...
	},
	{
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.4, 0.4, 0.4),   # Cracked gray
		"building": {"type": "Barricade", "size": Vector3(10, 5, 2), "pos": Vector3(10, 2.5, 10)},
		"npc": null  # No NPC due to battleground
	},
	{
		"name": "zeta_prime",
		"type": "Industrial",
		...
		"terrain_size": Vector3(100, 0.2, 100),
		"terrain_color": Color(0.5, 0.5, 0.6),   # Industrial gray
...
func generate_planet_scene(planet_data):
	...
	var root = Node3D.new()
	root.name = planet_data["name"].capitalize().replace("_", "")  # e.g., "BetaCeti"

	# Instance PlanetScene.tscn
	...
	var mesh_instance = ground.get_node("PlaneMesh")
	...
	if planet_data["npc"]:
		...
		if planet_data["npc"].has("mesh") and planet_data["npc"]["mesh"] == "SphereMesh":
			...
			hazard_material.albedo_color = Color(1, 0, 0)  # Red for hazards
